...
def get_trending_short_topic(mode: str) -> dict:
    ...
    result = llm_json(f"""You are a viral YouTube Shorts creator.
Topic seed: {topic}
Mode: {mode} (standalone_1 = betrayal/personal stories, standalone_2 = crime/finance/drama)
...
{{"title": "60 chars max, curiosity gap title",
  ...
  "hashtags": "#betrayal #truecrime #shocking #viral #shorts",
  "niche": "betrayal/crime/finance/drama",
  ...
  "replay_potential": 9}}""")
    ...
    if not result:
        result = {
            ...
            "hashtags": "#betrayal #shocking #truecrime #viral #shorts",
            "niche": "betrayal",
        }
...
def produce_standalone_short(mode: str) -> dict:
    ...
    for attempt in range(3):
        ...
        niche  = topic_data.get("niche", "betrayal")
        tags_str = topic_data.get("hashtags", "#shorts #betrayal #viral")
        ...
        description = f"{script}\n\n{tags_str}\n\nBetrayal DeepDive — New betrayal story every day."
...
def produce_teaser_short(main_topic: str, main_script: str = "") -> dict:
    """
...
{{"title": "TEASER: [shocking hook] | Full Story Coming Soon",
  ...
  "hashtags": "#betrayaldeepdive #shorts #comingsoon #shocking"}}""")
    ...
    download_background_clip("betrayal", bg_out)
...
def produce_recap_short(main_topic: str, main_video_url: str = "") -> dict:
    """
...
{{"title": "The moment that SHOCKED everyone | [topic]",
  ...
  "hashtags": "#betrayaldeepdive #shorts #shocking #mustsee"}}""")
