...
def generate_episode_hashtags(niche, topic):
    ...
    """
    category_tags_map = {
        "dark_horror":        ["#DarkDocumentary", "#TrueStory"],
        "seduction_dark":     ["#DarkDocumentary", "#Psychology"],
        "psychological_trap": ["#Psychology", "#TrueStory"],
        "supernatural_real":  ["#Paranormal", "#TrueStory"],
        "obsession_dark":     ["#DarkDocumentary", "#Psychology"],
    }
    ...
    try:
        ...
        topic_tags = []
    all_tags = category_tags + topic_tags + ["#BetrayalDeepDive"]
    seen = set(); final_tags = []
    for t in all_tags:
...
NICHE_MUSIC_MOOD = {
    "dark_horror":         "dread",
    "seduction_dark":      "sensual_tension",
    "psychological_trap":  "unease",
    "supernatural_real":   "eerie",
    "obsession_dark":      "obsessive_tension",
}
    ...
    if phase == "upload":
        ...
        try:
            ...
            send_post_upload_report(
                "BetrayalDeepDive", yt_url, vid_id, token,
