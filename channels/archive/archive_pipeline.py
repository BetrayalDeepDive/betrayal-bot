...
_DEEP_AUTHORITATIVE_HISTORICAL = [
    "en-GB-ThomasNeural", "en-GB-OliverNeural", "en-GB-EthanNeural",
...
# FIX (direct user report, July 24 2026 — same fix/rationale as Ch2/Ch3
...
# there is demand"): real stock-footage insert mixed in for the tangible
# scene types (document_reveal = real historical records/documents,
# portrait_reveal = a real historical figure's likeness/setting) —
# never map_highlight/map_movement, which are the real geography system
# and should never be replaced by generic stock footage.
_TANGIBLE_SCENE_TYPES = {"document_reveal", "portrait_reveal"}
...
def run_stage3_audio(script_clean, voice_id, niche_name):
    ...
    tg("\U0001f6a8 The Archive: every human voice failed today. There is no robotic "
